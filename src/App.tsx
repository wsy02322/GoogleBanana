...
import type { AspectRatio, ImageSize, Settings, Turn } from './lib/types'
import {
  loadSettings,
  saveSettings,
  loadHistory,
...
import { PlusIcon, SettingsIcon, SunIcon, MoonIcon } from './components/icons'
...
export default function App() {
  ...
  // Open settings automatically on first run when no key is set.
  useEffect(() => {
    ...
    <div className="flex h-full flex-col bg-white text-gray-900 dark:bg-gray-950 dark:text-gray-100">
      <header className="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-gray-800">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">GoogleBanana</h1>
